...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block'); // в 1м акордеоне 2 параметра для первого варианта акордеона 
  // accordion('.accordion-heading', '.accordion-block');
  // для 2го варианта акордеона с 1 параметром
...
var filter = function filter() {
  ...
  var btnLovers = document.querySelector('.lovers');
  var btnChef = document.querySelector('.chef');
  var btnGirl = document.querySelector('.girl');
  var btnGuy = document.querySelector('.guy');
  var btnGrandmother = document.querySelector('.grandmother');
  var btnGranddad = document.querySelector('.granddad');
  ...
  btnGrandmother.addEventListener('click', function () {
    // тут функцию запускаем без аргумента т.к. таких элементов нет
    typeFilter();
  });
...
var modals = function modals() {
  ...
  function bindModal(openModalSelector, modalSelector, closeModalSelector) {
    ...
    var openModal = document.querySelectorAll(openModalSelector);
    var modal = document.querySelector(modalSelector);
    var closeModal = document.querySelector(closeModalSelector);
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  ...
  btn.addEventListener('click', function () {
    ...
    }); // btn.style.display ='none'; // убираем кнопку так или как ниже 
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    ...
    var _nextBtn = document.querySelector(next);
